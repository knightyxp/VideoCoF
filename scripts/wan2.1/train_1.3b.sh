...
export DATASET_NAME=${DATASET_NAME:-datasets/internal_datasets}
export DATASET_META_NAME=${DATASET_META_NAME:-datasets/internal_datasets/metadata.json}
export CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0,1,2,3}
export OUTPUT_DIR=${OUTPUT_DIR:-experiments/wan2.1_1.3b_lora}
